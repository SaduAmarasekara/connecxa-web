          ...
          <div className="flex-1 z-10 flex flex-col justify-center w-full lg:max-w-[700px] pb-10 lg:pb-16 text-center lg:text-left items-center lg:items-start lg:ml-[50px] xl:ml-[80px]" style={{ marginLeft: 50 }}>
            ...
            <div className="flex flex-col gap-8 md:gap-10 items-center lg:items-start w-full">
              ...
              <div className="space-y-6 w-full">
                <h1 className="text-[36px] md:text-[56px] xl:text-[88px] font-black text-black leading-[1.05] md:leading-[1.02] tracking-[-0.04em]">
                  Ditch the Paper.<br />
                  <span className="text-black/70">Go Fully Digital.</span>
                </h1>
                <p className="text-[18px] md:text-[21px] text-black/70 leading-[1.6] font-medium max-w-[560px] mx-auto lg:mx-0">
