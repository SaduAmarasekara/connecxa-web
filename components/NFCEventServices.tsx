...
const ServiceCard = ({ title, desc, image }: ServiceCardProps) => {
  return (
    <div className="relative flex flex-col flex-1 min-w-[300px]" style={{ marginLeft: 50 }}>
      <div className="bg-white rounded-[32px] overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.06)] border border-gray-100 flex flex-col h-full">
        {/* Image */}
        ...
        <div className="p-8 md:p-10 flex flex-col flex-grow">
          <h3 className="text-[24px] md:text-[28px] font-[900] text-[#111827] mb-4 leading-tight">
            {title}
          </h3>
          <p className="text-gray-500 text-[16px] md:text-[17px] font-medium leading-relaxed">
            {desc}
          </p>
        </div>
      </div>
    ...
    <section className="bg-white py-16 md:py-24" style={{ fontFamily: "'DM Sans', sans-serif", marginLeft: 50 }}>
      <div className="max-w-[1400px] mx-auto px-6">
        ...
        <div className="text-center mb-16 md:mb-20 ">
          <h2 className="text-[42px] md:text-[56px] lg:text-[68px] font-[900] text-[#111827] leading-tight mb-6">
            All-in-One Service
          </h2>
          <p className="text-gray-500 text-[18px] md:text-[22px] font-medium max-w-[1400px] mx-auto ">
